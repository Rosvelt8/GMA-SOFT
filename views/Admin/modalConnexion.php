<div class="modal" id="AjouterClient">
    <div class="modal_content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div><input type="number" name="usercniCode"></div>
            <div><input type="text" name="userName"></div>
            <div><input type="password" name="userPassword"></div>
            <div><input type="number" name="userPhoneNumber"></div>
            <div><input type="text" name="userProfession"></div>
            <div><input type="text" name="userPlaceActivity"></div>
