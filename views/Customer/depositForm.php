...
require('../../controllers/Customer/newDepositAction.php');
include('head.php'); ?>
    <link rel="stylesheet" href="../assets/css/style_dash.css">
    <title>Formulaire de Depot</title>
  </head>
  <style>
...
.errorOperation .content{
  ...
  <body>
    ...
    <form method="post" class="form">
      <h1 class="text-center">Formulaire de depot</h1>
      <!-- Progress bar -->
      <div class="progressbar">
        ...
        <div
          ...
          data-title="Montant"
        ></div>
        <div class="progress-step" data-title="Mode paiement"></div>
      ...
      <div class="form-step form-step-active">
        ...
        <div class="input-group">
          <label for="position">montant depot</label>
          <input type="number" name="amountOperation" id="position" >
        </div>
        <div class="">
      ...
      <div class="form-step">
        <div class="statut">
            <input type="radio" class="statut1" name="paymentMode" value="MTN Mobile Money" id="">
            <input type="radio" name="paymentMode" class="statut2" value="Orange Money" id="">
        </div>
        <div class="input-group">
          <label for="email">Numéro de tèléphone</label>
          <input type="number" name="phoneNumber" id="email"  />
        </div>
